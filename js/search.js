...
$(document).ready(function(){
	$("button#search").click(function(){
		...
		var startnytapi="http://api.nytimes.com/svc/search/v2/articlesearch.json?fq=";
		var query;
		$("h2.portfolio-heading").append(query);
		$("input#search-query").text(query);
		//$("h2.portfolio-heading").append(query);
		console.log(query);
	   
		var apikey="&api-key=121dea6cb6ea419be7902939b74c9fe0%3A10%3A72139813";
		var nytapi=startnytapi+query+apikey;
		console.log(nytapi);
